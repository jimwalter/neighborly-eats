...
const client = yelp.client({
  'Authorization': {
    'Bearer': 'FmcTIWQe9mkAgUYOb5TzvE4rzlmNOl3v4qc3tPfmj-HZgCrb_1F0EV2q42WkmpUXn1V1DG3geGtm_cVvnT-5NUFj_wXIletgCLD_va8yxUtfehbizDfrNo_UH1eaXnYx'
  }
});


var search = client.search({
  category: 'Four Barrel Coffee',
  sort_by: 'rating',
}).then(response => {
